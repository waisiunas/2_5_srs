...
$sql = "SELECT * FROM `registrations` WHERE `id` = $reg_id";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($student_id)) {
        ...
        $sql = "SELECT * FROM `registrations` WHERE `student_id` = $student_id AND `course_id` = $course_id AND `id` != $reg_id";
        $result = $conn->query($sql);
        if ($result->num_rows == 0) {
            $sql = "UPDATE `registrations` SET `student_id` = $student_id, `course_id` = $course_id WHERE `id` = $reg_id";
            if ($conn->query($sql)) {
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?id=<?php echo $reg_id; ?>" method="POST">
